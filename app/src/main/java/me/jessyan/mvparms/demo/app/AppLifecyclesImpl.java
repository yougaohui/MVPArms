...
import me.jessyan.mvparms.demo.app.cache.IntelligentCache;
import me.jessyan.mvparms.demo.app.service.CoreService;
...
//                    });
        ...
        //初始化数据库
        // 项目在SDCard下创建的目录
        if (!ProjectUtils.init("ygh")) {
            // 失败
        }
        //启动服务
        application.startService(new Intent(application, CoreService.class));
    }
