...
import me.jessyan.mvparms.demo.db.DBModule;
    ...
    public void requestUsers(final boolean pullToRefresh) {
        ...
        PermissionUtil.requestPermission(new PermissionUtil.RequestPermission() {
            ...
            public void onRequestPermissionSuccess() {
                // 数据库
                DBModule.getInstance().init(mApplication);
            }
        ...
        }, mRootView.getRxPermissions(), mErrorHandler, Manifest.permission.READ_PHONE_STATE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE);
